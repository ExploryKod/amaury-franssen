...
<>
    ...
    <div className="gap-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 mx-auto w-full">
        ...
        <div key={project.id} className="relative flex bg-white shadow-md hover:shadow-lg rounded-lg max-w-[600px] transition duration-300 cursor-pointer group">            
            <>
            <div className="top-0 left-0 absolute flex gap-4 p-4">
            ...
            <h2 className="right-0 absolute bg-button p-2 rounded-tr-lg rounded-bl-lg font-bold text-2xl text-white">{project.title}</h2>
            
            
            <div className="top-0 right-0 bottom-0 left-0 z-10 absolute flex justify-between items-end bg-gray-0.5 rounded-t-lg">
